...
function params = init_params
    ...
    params.model.dyn.top.I = 0.001;% moment of inertia of top link
    params.model.dyn.mid.I = 0.001;% moment of inertia of mid link
    params.model.dyn.bot.I = 0.001;% moment of inertia of bot link
    ...
    params.model.dyn.b1 = 0.0;      % damping 1
    params.model.dyn.b2 = 0.0;      % damping 2
    params.model.dyn.b3 = 0.0;      % damping 3
    ...
    params.viz.colors.top_com = [1 0.4 0.7];
    params.viz.colors.top_tip = [1 0.4 0.7];
    params.viz.colors.mid_com = [1 0.6 0.7];
    params.viz.colors.mid_tip = [1 0.6 0.7];
    params.viz.colors.bot_com = [1 0.8 0.8];
    params.viz.colors.bot_tip = [1 0.8 0.8];
    
    params.viz.colors.tracers.top_com = 'm';
    params.viz.colors.tracers.top_tip = 'm';
    params.viz.colors.tracers.mid_com = 'y';
    params.viz.colors.tracers.mid_tip = 'y';
