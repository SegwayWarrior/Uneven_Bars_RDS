...
%% Load link Images and Define Angles

% Note: to get the rectangular link models as opposed to the actual images
% of the links, comment out three sections below (Plot Link 1, Plot Link 2,
% Plot Link 3), then uncomment the Plot Rectangular Links Section (also
% below)
...
%% Plot Rectangular Links (as opposed to acutual images)
