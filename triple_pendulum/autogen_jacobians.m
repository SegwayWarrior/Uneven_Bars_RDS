...
if nargout > 2
    ...
    t5 = l_top.*t2;
    t6 = cos(t4);
    dx_com_mid = dtheta_1.*(t5+r_com_mid.*t6)+dtheta_2.*r_com_mid.*t6;
end
if nargout > 3
    t7 = l_top.*t3;
    t8 = sin(t4);
    dy_com_mid = dtheta_1.*(t7+r_com_mid.*t8)+dtheta_2.*r_com_mid.*t8;
end
if nargout > 4
    t9 = t4+theta_3;
    t10 = cos(t9);
    ...
    t14 = r_com_bot.*t11;
    t15 = r_com_bot.*t10;
    dx_com_bot = dtheta_2.*(t12+t15)+dtheta_3.*t15+dtheta_1.*(t5+t12+t15);
end
if nargout > 5
    dy_com_bot = dtheta_2.*(t13+t14)+dtheta_3.*t14+dtheta_1.*(t7+t13+t14);
end
