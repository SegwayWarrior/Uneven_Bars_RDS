...
for i = 1:size(q_list,2)
    ...
    if tracing
            ...
            top.x = [top.x,params.model.higher.top.x];
            top.y = [top.y,params.model.higher.top.y];

            top.curr.tip.x = [top.curr.tip.x,FK(1,2)+params.model.higher.top.x];
            top.curr.tip.y = [top.curr.tip.y,FK(2,2)+params.model.higher.top.y];

            mid.curr.tip.x = [mid.curr.tip.x,FK(1,4)+params.model.higher.top.x];
            mid.curr.tip.y = [mid.curr.tip.y,FK(2,4)+params.model.higher.top.y];
