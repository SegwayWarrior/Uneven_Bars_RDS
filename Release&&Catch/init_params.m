...
% damping coefficient
    params.model.dyn.b1 = 0.5;      % damping 1
    params.model.dyn.b2 = 0.5;      % damping 2
    params.model.dyn.b3 = 0.5;      % damping 3
...
%% parameters that help with visualizing the robot:
 ...
 % parameters related to simulating (integrating) the dynamics forward
    ...
    params.sim.ICs.dtheta_1 = catch_state(8,1);     % initial theta_1 velocity
    params.sim.ICs.dtheta_2 = catch_state(9,1);     % initial theta_2 velocity
    params.sim.ICs.dtheta_3 = catch_state(10,1);     % initial theta_3 velocity
