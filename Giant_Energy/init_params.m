...
function params = init_params
    ...
    params.sim.ICs.theta_1 = pi;     % initial theta_1 position
    ...
    params.sim.ICs.dtheta_1 = 1; % initial theta_1 velocity
    ...
    params.sim.tfinal = 15; % simulation final time
    ...
    % list of constraints (pumping, giant, bar1, flight, bar2)
    params.sim.constraints = ['giant'];   % initially, constraint is active
