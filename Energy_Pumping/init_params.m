...
function params = init_params
    ...
    params.sim.ICs.theta_1 = .01;     % initial theta_1 position
    ...
    params.sim.tfinal =50; % simulation final time
    ...
    % list of constraints (pumping, bar1, flight, bar2)
    params.sim.constraints = ['pumping'];   % initially, constraint is active
