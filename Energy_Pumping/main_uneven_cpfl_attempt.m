...
u_accel_2 = kp_ac*(th2_des - th2) + kd_ac*(0 - th2_dot);
u_accel_3 = kp_ac*(th3_des - th3) + kd_ac*(0 - th3_dot);

u_accel = [u_accel_2; u_accel_3];

inv(M_uu);

torq_cpfl = (M_aa - M_au*inv(M_uu)*M_ua)*u_accel + M_au.*inv(M_uu).*H_u + H_a;
            
tau_shoulders = torq_cpfl(1);
tau_hips = torq_cpfl(2);
...
% if tot_energy reached, make theta2 and 3 zero
if(totEner > 300)
    pass1 = 1;
else
    pass1 = 0;
end
if(pass1 == 1) && (totEner < 100)
    pass1 = 0
end
if(pass1 == 1)
    th2des = 0;
