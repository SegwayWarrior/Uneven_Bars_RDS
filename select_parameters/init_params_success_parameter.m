% init_params.m
function params = init_params_success_parameter
...
%     params.sim.ICs.theta_1 = pi/3;%pi/2(2.9,1.2);    %pi/3(10,5);   % initial theta_1 position
%     params.sim.ICs.theta_2 = pi/2;%pi/3;   %pi/4;      % initial theta_2 position
%     params.sim.ICs.theta_3 = 0;%0;   %0;      % initial theta_3 position
%     
%     params.sim.ICs.dtheta_1 = 4.8;%1;  %2.5;     % initial theta_1 velocity
%     params.sim.ICs.dtheta_2 = 2;%2;  %1;     % initial theta_2 velocity
%     params.sim.ICs.dtheta_3 = 1;%2;  %1;     % initial theta_3 velocity
...
%% add the bar position
    ...
    params.model.higher.top.x = 2.9; % higher bar location
    params.model.higher.top.y = 1.2;
    params.model.higher.bot.x = 2.9;
