...
hold on;
scatter(params.model.lower.top.x,params.model.lower.top.y,params.model.geom.motor.mr2*2,...
    'MarkerEdgeColor',[0,0,0],...
    'MarkerFaceColor',[0,0,0]);
hold on;
scatter(params.model.higher.top.x,params.model.higher.top.y,params.model.geom.motor.mr2*2,...
    'MarkerEdgeColor',[0,0,0],...
    'MarkerFaceColor',[0,0,0]);
hold on;
