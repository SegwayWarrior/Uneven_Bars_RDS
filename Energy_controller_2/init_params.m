...
function params = init_params
    ...
    params.model.dyn.b3 = 0.3;      % damping 3
    params.model.dyn.b4 = 0.3;      % damping 4
    params.model.dyn.b5 = 0.3;      % damping 5
    ...
    params.sim.tfinal = 60; % simulation final time
